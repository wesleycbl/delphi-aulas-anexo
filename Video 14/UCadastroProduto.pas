      ...
      0:
        begin
          x := 'INSERT INTO TBPRODUTO (VALORVENDAPROD, ESTOQUEPROD, NOMEPROD, FKCATEGORIA, FKFABRICANTE)'
            ...
            ',' + QuotedStr(Edtnomeprod.Text) + ',' + EdtFkcategoria.Text + ','
            + CBFKFabricante.Text + ')';
        end;
      1:
        begin
          x := ' UPDATE TBPRODUTO ' + ' SET' + '  VALORVENDAPROD = ' +
            Edtvalorvendaprod.Text + ', ESTOQUEPROD = ' + Edtestoqueprod.Text +
            ', NOMEPROD = ' + QuotedStr(Edtnomeprod.Text) + ', FKCATEGORIA = ' +
            EdtFkcategoria.Text + ', FKFABRICANTE = ' + CBFKFabricante.Text +
